...
path=$(find ~/Library/Developer/Xcode/DerivedData/flu-sense-*/Build/Products/Debug-iphonesimulator -name "flu-sense.app" | head -n 1)
echo "${path}"
...
xcrun simctl launch "$line" com.visal.lk.flu-sense # Launch .app using its bundle at simulator with identifier hold by $line var
done
